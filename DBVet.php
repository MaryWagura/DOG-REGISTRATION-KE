...
$Location=$_POST ['Location'];
 $sql = "INSERT INTO vetdetails(FirstName, LastName, IDNumber, PhoneNumber, Email, Age, Gender, Location)
...
$insert= $dbname->query("SELECT FirstName, LastName, IDNumber, PhoneNumber, Email, Age, Gender, Location FROM vetdetails");
